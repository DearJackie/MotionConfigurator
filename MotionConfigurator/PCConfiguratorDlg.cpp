...
void CPCConfiguratorDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDV_MinMaxFloat(pDX, m_fParamW, 0.005f, 60.0f);
	DDX_Text(pDX, IDC_EDIT_PARAM_SPEED, m_fParamRs);
	DDV_MinMaxFloat(pDX, m_fParamRs, 20.0f, 600.0f);
	DDX_Text(pDX, IDC_EDIT_CONV_ROLLING_SPEED, m_fParamCBs);
	DDV_MinMaxFloat(pDX, m_fParamCBs, 0.5f, 5.0f);
	DDX_Text(pDX, IDC_EDIT_SETUP_DX, m_fParamDx);
	DDV_MinMaxFloat(pDX, m_fParamDx, 0.005f, 50.0f);
	DDX_Text(pDX, IDC_EDIT_SETUP_DY, m_fParamDy);
	DDV_MinMaxFloat(pDX, m_fParamDy, 0.005f, 50.0f);
	DDX_Text(pDX, IDC_EDIT_SETUP_DZ, m_fParamDz);
	DDV_MinMaxFloat(pDX, m_fParamDz, 0.005f, 10.0f);
	DDX_Control(pDX, IDC_STATIC_PIC, m_ctrlStaticPic);
}
...
ON_BN_CLICKED(IDC_BTN_GO, &CPCConfiguratorDlg::OnClickedBtnGo)
END_MESSAGE_MAP()
...
{
	/*m_ctrlStaticPic.ModifyStyle(0, BS_BITMAP);
	if (m_ctrlStaticPic.GetBitmap() == NULL)
	{
		m_ctrlStaticPic.SetBitmap(::LoadBitmap(::AfxGetInstanceHandle(), MAKEINTRESOURCE(IDI_ICON_ROUTINE)));
	}*/

	/*m_ctrlStaticPic.ModifyStyle(0, BS_ICON);
	if (m_ctrlStaticPic.GetIcon() == NULL)
	{
		m_ctrlStaticPic.SetIcon(::LoadIcon(::AfxGetInstanceHandle(), MAKEINTRESOURCE(IDI_ICON_CONNECT)));
	}*/
...
void CPCConfiguratorDlg::OnClickedBtnGo()
{
	SendCommands(IDC_BTN_GO);
}
