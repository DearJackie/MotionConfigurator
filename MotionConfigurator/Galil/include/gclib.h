...
#define G_HUGE_BUFFER 524288 //!< Most reads/writes to Galil hardware are small. This value will hold the largest array or program upload/download possible.
  ...
  *
	...
	*      A valid connection (g) is not necessary, i.e. g may be null. On Linux and Mac, the address to assign will be pinged to ensure its
	*      availability before the assign packet is sent. `G_GCLIB_UTILITY_IP_TAKEN` will be returned by GUtility() if the ping returns a response.
